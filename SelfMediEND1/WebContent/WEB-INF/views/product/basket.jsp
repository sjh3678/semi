...
<c:import url="/WEB-INF/views/layout/headerbs.jsp" />
	...
	<br><br>
		...
		<div class="btnwrap">
			<span style="padding-right: 20px"><button class="btn" id="compbtn">상품비교하기</button></span>
			<span style="padding-left: 20px"><button class="btn" id="mergebtn">상품합산하기</button></span>
		</div>
</body>
