...
<div class="container">
		...
		<div class="producttb">
			<table class="product"  style="cellspacing: 0; border-collapse: collapse;" >
				<thead>
					...
					<tr>
						<td class="producttd" style="width:146.25px;background-color: #EEE;">제조사 </td>
					...
					<tr>
						...
						<td class="score" style="width:146.25px;background-color: #EEE;">별점</td>
	...
	<div class="nutdiv"  style="width:1170px;">
		<table class="nutheadtb" style="cellspacing: 0; border-collapse: collapse;">
			<tr class="nuttr" style="height:50px;">
				<td class="nut" style="width:80px;background-color: #EEE;">함유 영양소</td>
				<td class="nut" colspan="2" style="width:600px;background-color: #EEE;">권장량 비교 그래프</td>
				<td class="nut" style="width:260px;background-color: #EEE;">함량</td>
				<td class="nut" style="width:260px;background-color: #EEE;">권장량</td>	
			</tr>
