...
<table class="tg">
	...
	<thead>
		<tr>
			...
			<td class="tg-prodctName" colspan="2">${productInfo.productName }</td><!-- 상품명 -->
		</tr>
		<tr>
			<td style="background-color: #EEE;">별점</td>
		...
		<tr>
			<td style="background-color: #EEE;">제조사</td>
			<td class="tg-manuCom">${productInfo.manuCom }</td><!-- 제조사 -->
		</tr>
		<tr>
			<td style="background-color: #EEE;">타입</td>
			<td class="tg-type">${productInfo.type }</td><!-- 타입 -->
		</tr>
		<tr>
			<td class="tg-Link" colspan="2"><a href="${productInfo.purchaseLink }">구매하러가기</a></td><!-- 구매 링크 -->
		</tr>
		<tr>
...
<table class="tg" style="undefined;table-layout: fixed; width: 1050px">
	...
	<c:forEach items="${nikList }" var="nik">
		<thead>
			<tr>
				<td style="background-color: #EEE;">함유 영양소</td>
				<td  colspan="2" style="background-color: #EEE;">권장량 그래프</td>
				<td style="background-color: #EEE;">함량</td>
				<td style="background-color: #EEE;">권장량</td>
				<td style="background-color: #EEE;">상세</td>
			</tr>
		</thead>
		...
		<tfoot id="detail${nik.ni.nutId }" class="detail">
			<tr>
				<td class="tg" style="width:80px;background-color: #EEE;">기능 / 특성</td>
				<td class="tg-detail" colspan="5">${nik.nk.effect }</td>
			</tr>
			<tr>
				<td class="tg" style="width:80px;background-color: #EEE;">결핍증</td>
				<td class="tg-detail" colspan="5">${nik.nk.deficiency }</td>
			</tr>
			<tr>	
				<td class="tg" style="width:80px;background-color: #EEE;">과잉증</td>
