...
@WebServlet("/notice/comment/update")
public class NoticeCommentUpdateController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
    	...
    	System.out.println("/notice/comment/Uupdate [GET]");		
    	
    	noticeService.commentUpdate(req);
