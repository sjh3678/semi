package com.fulldoping.free.paging;
...
public class FreePaging {
	...
	//총 게시글 수를 입력하는 생성자
	public FreePaging(int totalCount) {
	...
	public FreePaging(int totalCount, int curPage) {
		setTotalCount(totalCount);
		setCurPage(curPage);
	...
	public FreePaging(int totalCount, int curPage, int listCount) {
		setTotalCount(totalCount);
		setCurPage(curPage);
	...
	public FreePaging(int totalCount, int curPage, int listCount, int pageCount) {
		setTotalCount(totalCount);
		setCurPage(curPage);
		setListCount(listCount);
