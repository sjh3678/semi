package com.fulldoping.admin.freedeclare.paging;

public class FreeDeclarePaging {
	...
	public FreeDeclarePaging() { }
	
	//총 게시글 수를 입력하는 생성자
	public FreeDeclarePaging(int totalCount) {
	...
	public FreeDeclarePaging(int totalCount, int curPage) {
		setTotalCount(totalCount);
		setCurPage(curPage);
	...
	public FreeDeclarePaging(int totalCount, int curPage, int listCount) {
		setTotalCount(totalCount);
		setCurPage(curPage);
	...
	public FreeDeclarePaging(int totalCount, int curPage, int listCount, int pageCount) {
		setTotalCount(totalCount);
		setCurPage(curPage);
		setListCount(listCount);
