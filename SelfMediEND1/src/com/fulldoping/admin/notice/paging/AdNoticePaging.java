package com.fulldoping.admin.notice.paging;

public class AdNoticePaging {
	...
	public AdNoticePaging() { }
	
	//총 게시글 수를 입력하는 생성자
	public AdNoticePaging(int totalCount) {
	...
	public AdNoticePaging(int totalCount, int curPage) {
		setTotalCount(totalCount);
		setCurPage(curPage);
	...
	public AdNoticePaging(int totalCount, int curPage, int listCount) {
		setTotalCount(totalCount);
		setCurPage(curPage);
	...
	public AdNoticePaging(int totalCount, int curPage, int listCount, int pageCount) {
		setTotalCount(totalCount);
		setCurPage(curPage);
		setListCount(listCount);
