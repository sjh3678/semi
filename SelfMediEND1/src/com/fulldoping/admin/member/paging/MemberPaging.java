package com.fulldoping.admin.member.paging;
...
private int curPage;	//현재 페이지 번호
	...
	private int totalPage;	//총 페이지의 수 = totalCount / listCount
	...
	//총 게시글 수를 입력하는 생성자
	public MemberPaging(int totalCount) {
	...
	public MemberPaging(int totalCount, int curPage) {
		setTotalCount(totalCount);
		setCurPage(curPage);
	...
	public MemberPaging(int totalCount, int curPage, int listCount) {
		setTotalCount(totalCount);
		setCurPage(curPage);
	...
	public MemberPaging(int totalCount, int curPage, int listCount, int pageCount) {
		setTotalCount(totalCount);
		setCurPage(curPage);
		setListCount(listCount);
