package com.fulldoping.admin.qnadeclare.paging;

public class QnADeclarePaging {
	...
	public QnADeclarePaging() { }
	
	//총 게시글 수를 입력하는 생성자
	public QnADeclarePaging(int totalCount) {
	...
	public QnADeclarePaging(int totalCount, int curPage) {
		setTotalCount(totalCount);
		setCurPage(curPage);
	...
	public QnADeclarePaging(int totalCount, int curPage, int listCount) {
		setTotalCount(totalCount);
		setCurPage(curPage);
	...
	public QnADeclarePaging(int totalCount, int curPage, int listCount, int pageCount) {
		setTotalCount(totalCount);
		setCurPage(curPage);
		setListCount(listCount);
