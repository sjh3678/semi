package com.fulldoping.admin.free.paging;

public class AdFreePaging {
	...
	//총 게시글 수를 입력하는 생성자
	public AdFreePaging(int totalCount) {
	...
	public AdFreePaging(int totalCount, int curPage) {
		setTotalCount(totalCount);
		setCurPage(curPage);
	...
	public AdFreePaging(int totalCount, int curPage, int listCount) {
		setTotalCount(totalCount);
		setCurPage(curPage);
	...
	public AdFreePaging(int totalCount, int curPage, int listCount, int pageCount) {
		setTotalCount(totalCount);
		setCurPage(curPage);
		setListCount(listCount);
