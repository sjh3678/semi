package com.fulldoping.admin.qna.paging;

public class AdQnaPaging {
	...
	//총 게시글 수를 입력하는 생성자
	public AdQnaPaging(int totalCount) {
	...
	public AdQnaPaging(int totalCount, int curPage) {
		setTotalCount(totalCount);
		setCurPage(curPage);
	...
	public AdQnaPaging(int totalCount, int curPage, int listCount) {
		setTotalCount(totalCount);
		setCurPage(curPage);
	...
	public AdQnaPaging(int totalCount, int curPage, int listCount, int pageCount) {
		setTotalCount(totalCount);
		setCurPage(curPage);
		setListCount(listCount);
