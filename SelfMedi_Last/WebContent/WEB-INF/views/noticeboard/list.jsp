...
<h1 style= "text-align:center;color:black;font-weight:bold;" >공지사항</h1>
<hr>
</div>
...
<c:forEach items="${noticeList }" var="notice">
  <tr>
    <td class="tg-xphl" style= "text-align: center;">${notice.boardNo }</td>
    <td class="tg-xphl" ><a href="/notice/view?boardNo=${notice.boardNo }" style="color:black;">
		${notice.boardTitle }
		</a></td>
<%--     <td class="tg-xphl">${free.userId }</td> --%>
    <td class="tg-xphl" style= "text-align: center;">${notice.userNick }</td>
    <td class="tg-xphl" style= "text-align: center;">${notice.hit }</td>
    <td class="tg-xphl" style= "text-align: center;">${notice.boardDate }</td>
  </tr>
</c:forEach>
</tbody>
</table>
