...
<style type="text/css">
#container {padding: 0px 0px 120px;}

form#form {width: 680px;padding-top: 50px;}

.memberJoin {width: 640px;margin: 0 auto;}
...
.memberJoin .tbl_comm .userId td {padding-top: 19px;}
.typeForm .btnDefault {
    border: 1px solid #345ff6;
    background-color: #fff;
    color: #345ff6;
}
.memberJoin .btnDefault {display: inline-block;width: 120px;margin-left: 5px;vertical-align: top;}
.typeForm .btnDefault {
    height: 44px;
    border-radius: 3px;
    font-weight: 700;
...
.memberJoin input[type=text], .memberJoin input[type=password] {
    width: 332px;
}

.typeForm textarea, .typeForm input[type=text], .typeForm input[type=password] {
...
<form id="form" name="frmMember" action="/member/join" method="post">

<div class="titPage">
	<h2 class="title">회원가입</h2>
	<p class="pageSub"><span class="ico">*</span>필수입력사항</p>
	<hr>
</div>
