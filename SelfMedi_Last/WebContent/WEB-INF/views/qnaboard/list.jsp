...
<div class="container">
<h1 style= "text-align :center;color:black;font-weight:bold;" >QnA</h1>
<hr>
...
<c:forEach items="${boardList }" var="board">
  <tr>
    <td class="tg-xphl" style= "text-align: center;">${board.boardNo }</td>
    <td class="tg-xphl" ><a href="/qna/view?boardNo=${board.boardNo }" style="color:black;">
		${board.boardTitle }
		</a></td>
<%--     <td class="tg-xphl">${free.userId }</td> --%>
    <td class="tg-xphl" style= "text-align: center;">${board.userNick }</td>
    <td class="tg-xphl" style= "text-align: center;">${board.hit }</td>
    <td class="tg-xphl" style= "text-align: center;">${board.boardDate }</td>
  </tr>
</c:forEach>
</tbody>
</table>
