...
<input type="hidden" name="boardNo" value="${updateFree.boardNo }" />

<table class="table table-bordered">
<tr><td class="info">아이디</td><td>${updateFree.userId }</td></tr>
<tr><td class="info">닉네임</td><td>${userNick }</td></tr>
<tr><td class="info">제목</td><td><input type="text" name="title" style="width:100%" value="${updateFree.boardTitle }"/></td></tr>
<tr><td class="info" colspan="2">본문</td></tr>
<tr><td colspan="2"><textarea id="content" name="content">${updateFree.boardContent }</textarea></td></tr>
</table>
