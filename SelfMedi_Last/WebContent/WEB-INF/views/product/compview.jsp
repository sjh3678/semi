...
<div class="container">
		...
		<div class="producttb">
			<table class="product" style="cellspacing:0;border-collapse:collapse;text-align:center;">
				<thead>
					...
					<tr>
						<td style="width:146.25px;background-color: #EEE;font-weight:bold;">제조사 </td>
					...
					<tr>
						...
						<td style="width:146.25px;background-color: #EEE;font-weight:bold;">별점</td>
	...
	<div class="nuthead">
		<table style="text-align:center;font-weight:bold;">
			<tr class="nut" style="height:50px;text-align:center;">
				<td style="width:80px;background-color: #EEE;font-weight:bold;">함유 영양소</td>
				<td  colspan="2" style="width:285px;background-color: #EEE;font-weight:bold;">권장량 비교 그래프</td>
				<td style="width:110px;background-color: #EEE;font-weight:bold;">함량</td>
				<td style="width:110px;background-color: #EEE;font-weight:bold;">권장량</td>	
			</tr>
		</table>
	</div>

	<div class="nuthead">
		<table style="cellspacing: 0; border-collapse: collapse;text-align:center;">
